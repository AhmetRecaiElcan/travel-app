...
import 'package:bruh/models/car_dealer.dart';
import 'package:bruh/models/car_model.dart';
import 'package:bruh/screens/car_rental/car_details.dart';
      ...
      list.add(GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => CarDetailsScreen(car: cars[i])),
            );
          },
