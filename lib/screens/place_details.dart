...
import 'package:bruh/models/popular_model.dart';
import 'package:bruh/screens/car_rental/car_rental.dart';
import 'package:bruh/screens/hotel/hotel_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: isLightTheme
                ? ColorsConstants.appColor.withOpacity(0.06)
                : ColorsConstants.appColor.withOpacity(0.09),
            borderRadius: BorderRadius.circular(16)),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Row(
              children: [
                Container(
                  padding: const EdgeInsets.all(12),
                  decoration: BoxDecoration(
                      color: ColorsConstants.appColor.withOpacity(0.1),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
                border: Border.all(
                    color: isLightTheme
                        ? ColorsConstants.iconLight.withOpacity(0.5)
                        : Colors.white.withOpacity(0.5)),
    ...
    return Row(
      ...
      children: [
        Icon(
          Icons.star,
          size: size,
          color: rating >= 1 ? ColorsConstants.appColor : Colors.white70,
        ),
        const SizedBox(
          width: 1,
        ),
        Icon(
          Icons.star,
          size: size,
          color: rating >= 2 ? ColorsConstants.appColor : Colors.white70,
        ),
        const SizedBox(
          width: 1,
        ),
        Icon(
          Icons.star,
          size: size,
          color: rating >= 3 ? ColorsConstants.appColor : Colors.white70,
        ),
        const SizedBox(
          width: 1,
        ),
        Icon(
          Icons.star,
          size: size,
          color: rating >= 4 ? ColorsConstants.appColor : Colors.white70,
        ),
        const SizedBox(
          width: 1,
        ),
        Icon(
          Icons.star,
          size: size,
          color: rating >= 5 ? ColorsConstants.appColor : Colors.white70,
        ),
      ],
    );
  }
