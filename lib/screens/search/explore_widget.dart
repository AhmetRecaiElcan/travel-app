...
import 'package:bruh/screens/search/ui_helper.dart';
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.only(
                  topLeft: Radius.circular(realW(currentExplorePercent)),
                  topRight: Radius.circular(realW(currentExplorePercent)))),
          child: Stack(
            children: [
              Positioned(
