...
import 'package:bruh/models/event_type_model.dart';
import 'package:bruh/models/near_by_model.dart';
import 'package:bruh/utils/colors_const.dart';
import 'package:bruh/utils/common_functions.dart';
import 'package:bruh/utils/date_time_picker/date_picker_widget.dart';
import 'package:bruh/utils/datetime_utils.dart';
...
class _EventScreenState extends State<EventScreen>
            ...
            itemBuilder: (context, index) {
              ...
              var animation = Tween<double>(begin: 800.0, end: 0.0).animate(
                CurvedAnimation(
                  parent: controller!,
                  curve: Interval(
                      (1 / nearByConcertModelList.length) * index, 1.0,
  ...
  Widget _buildCalendar() {
    return Container(
      ...
      child: DatePicker(
        ...
        selectionColor: ColorsConstants.appColor,
  ...
  Widget buildUpComingEventList() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
        Text(Strings.upcomingEvent, style: headerStyle),
        const SizedBox(
          height: 16,
        ),
        SizedBox(
