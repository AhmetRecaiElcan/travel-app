...
import 'package:bruh/carousel/carousel_pro.dart';
import 'package:bruh/models/popular_model.dart';
import 'package:bruh/screens/hotel/hotel_booking.dart';
          ...
          Row(
            children: [
              RatingBarIndicator(
                ...
                itemCount: 5,
                itemSize: 15.0,
                unratedColor: ColorsConstants.appColor.withAlpha(50),
  ...
  _buildCheckOutDays(bool isLightTheme, PopularModel hotel) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(20),
        border: Border.all(
            width: 0.5, color: ColorsConstants.appColor.withOpacity(0.3)),
      ),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
