...
import 'package:bruh/screens/profile/edit_profile.dart';
import 'package:bruh/screens/profile/privacy_policy.dart';
import 'package:bruh/screens/profile/setting/address_screen.dart';
import 'package:bruh/screens/profile/setting/setting_screen.dart';
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              menu.isDarkTheme
                  ? CommonFunctions.switchWidget(context)
                  : Icon(
                      Icons.chevron_right,
  ...
  Widget build(BuildContext context) {
    List<ProfileMenuModel> profileMenuList = [
      ProfileMenuModel(
          ...
          onTap: () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (builder) => const PrivacyPolicyScreen()));
          }),
      ProfileMenuModel(
