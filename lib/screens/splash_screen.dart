...
import 'package:bruh/walkthrough/travel_walkthrough.dart';
  ...
  void initState() {
    ...
    Timer(
        ...
        () => Navigator.of(context).pushReplacement(
            CommonFunctions.pushWithRightAnimation(
                child: const TravelWalkThrough(),
      ...
      child: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              // stops: [0.1, 0.5],
              colors: [ColorsConstants.appColor2, ColorsConstants.appColor],
            ),
              ...
              Column(
                children: [
                  ...
                  Lottie.asset('assets/images/splash_loading.json',
                      ...
                      width: MediaQuery.of(context).size.height * 0.3 + 50,
                      repeat: true),
                  const SizedBox(
                    height: 80,
                  ),
