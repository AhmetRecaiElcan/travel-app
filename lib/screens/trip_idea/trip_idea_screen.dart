...
import 'package:bruh/models/fav_place_video_model.dart';
import 'package:bruh/models/interest_model.dart';
import 'package:bruh/models/mountain_model.dart';
import 'package:bruh/models/top_destination_model.dart';
import 'package:bruh/screens/interest/discover_interest_page.dart';
import 'package:bruh/screens/interest/interest_details.dart';
            ...
            child: ListView.builder(
                ...
                itemBuilder: (cxt, index) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => const InterestDetailPage()));
                    },
                    child: Container(
                      width: 250,
                      margin: const EdgeInsets.only(right: 10),
